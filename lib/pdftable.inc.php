...
if($_SESSION['orientacion'] == 'L' and $_SESSION['hoja'] == 'Legal')  {  
  $celda1 = 5;
  $celda2 = 300;  
} 
if($_SESSION['orientacion'] == 'P'  and $_SESSION['hoja'] == 'Legal')  {  
  $celda1 = 5;
  $celda2 = 170;  
}

if($_SESSION['orientacion'] == 'L' and $_SESSION['hoja'] == 'A4')  {  
  $celda1 = 5;
  $celda2 = 250;  
} 
if($_SESSION['orientacion'] == 'P' and $_SESSION['hoja'] == 'A4')  {  
  $celda1 = 5;
  $celda2 = 160;  
} 	 
...
//Logo 2
  ...
  $this->htmltable($_SESSION['repor_enc']);
}
...
//Arial italic 8
   $this->SetFont('Arial','',8);
//Número de página
   $this->Cell($celda3,10,'Impreso el día '.$fecha.'- Hora '.$hora.' hs.',0,0,'L');		
   $this->Cell($celda4,10,'-- '.$this->PageNo().'/{nb} --',0,0,'L');
   $this->SetFont('Arial','',7);	
}
//Pie de página
